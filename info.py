...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/43d26c54d37f4afb830f7.jpg")
WELCOM_TEXT = environ.get("WELCOM_TEXT", "Hai {user}\nwelcome to {chat}\njoin bot update channel @mavimovie")
